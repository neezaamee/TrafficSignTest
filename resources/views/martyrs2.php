<?php
$con= mysql_connect("localhost", "ctpfsdgo","15VttLlq07");
mysql_select_db("ctpfsdgo_web");
?>
<!DOCTYPE HTML>
<html>
<head>
...
<script >
function checkForm(){
	if (document.getElementById('fir_no').value=="" || document.getElementById('fir_year').value==""){
		alert("Please fill both fields to track your FIR");
		return false;
	}
}
</script>
...
<td width="73%">
<span style="color:#FFFFFF; font-weight:normal;"><marquee behavior="scroll" scrolldelay="100" scrollamount="1" right="0" style="height:20px; overflow:hidden" width= "100%" direction="up" loop="true" onMouseOut="this.start();" onMouseOver="this.stop();">
       	CTP Faisalabad has launched android app. To download please <br><br>
		search City Traffic Police Faisalabad at Play Store<br><br>
		CTP Faisalabad started web radio. To listen CTP Radio please<br><br>
		Visit link: ctpfsdradio.tk
        </marquee>                  		
 </span>
</td>
...
<div class="main">
    <div class="main_page">
        	<h3>Salute Our Martyrs</h3>
            <br>
    <ul>
    <table>
    <tr>
    <td width="30"></td>
    <td width="200"><span style="font-size:18px; font-weight:bold; color:#000000;">MARTYR NAME</span></td>
    <td width="200" align="center"><span style="font-size:18px; font-weight:bold; color:#000000;">RANK & NO</span></td>
    <td width="200" align="center"><span style="font-size:18px; font-weight:bold; color:#000000;">DATE OF BIRTH</span></td>
    <td width="200" align="center"><span style="font-size:18px; font-weight:bold; color:#000000;">DATE OF SHAHADAT</span></td>
    <td width="200" align="center"><span style="font-size:18px; font-weight:bold; color:#000000;">DETAILS</span></td>
    </tr>
    <?php 
	$result2= mysql_query("select * from martyrs order by mart_id desc"); 
    while ($row2=mysql_fetch_array($result2))
    { 
    ?>
    <tr>
        <td width="30"><img src="images/marker1.png"> </td>  <td width="200"> <?php echo stripslashes($row2['mart_name'])."&nbsp;&nbsp;</td>". "<td align=center width=" . "200>" . stripslashes($row2['mart_rank']) . "&nbsp;&nbsp;</td>". "<td align=center width=" . "200>" .  stripslashes($row2['mart_doj']) . "</td>". "<td align=center width=" . "200>" .  stripslashes($row2['mart_dosh']) . "</td>" . "<td align=center width=" . "200>" . '<a href="martyrdetail.php?id='.stripslashes($row2['mart_id']).'">' . "&nbsp;&nbsp;" ."<span style=" . "color:red;" . ">" . "Click Here" . "<br></a></td>";}?>
    </tr></table>
    </ul>
    <br>
    </div>
...
<div class="wrap">
	<div class="footer-grids">
     <div style="height:195px; background-color:#dce4f1">        <div class="footer-grid">
			<p><a href="https://www.facebook.com/ctpfaisalabad?ref=br_tf" target="_blank"><img src="images/facebook-logo.png" width="160" height="48"></a></p>
			<p><a href="https://www.twitter.com/ctpfsd" target="_blank"><img src="images/twitter_logo.png" width="160" height="48"></a></p>
			<p><a href="https://www.youtube.com/c/citytrafficpolicefaisalabad" target="_blank"><img src="images/youtube.png" width="160" height="48"></a></p>
...
<div class="footer-grid">
		   ...
		   ?>
			...
			<h3>CONTACT US</h3>
			<p>CTO Office, Near Civil Lines Police Station, Opposite Kachehrian.</p>
		<div class="footer-grid-address">			<p>Tel. +92-41-9200514, 9200714</p>
			<p>Help Line. 1915</p>
			<p>Fax: +92-419200515</p>
<p>Email:<a class="email-link" href="#">fsd.ctp@gmail.com</a></p><br>
        </div>
	    </div>
     </div>
     <div class="wrap">
