    ...
    <div class="ui stackable grid">
        <div class="complaint contentBox" style="width: 100%;">
            ...
            <div class="complaintForm sixteen wide mobile ten wide tablet six wide computer column centered">
                <form action="<?= base_url() ?>/AdminPanel/addCTOhistory" method="post" id="regComp" style="margin-top: 20px">
                    <div class="ui form piled segment secondary red">
                        <div class="ui fields">
                            <div class="required sixteen wide field">
                                <label>CTO Name:</label>
                                <input type="text" name="ctoname" id="ctoname">
                            </div>
                        ...
                        <div class="ui fields">
                            <div class="required sixteen wide field">
                                ...
                                <input type="date" name="datetransfer" id="datetransfer">
                            </div>
                        </div>
                        <div class="ui fields">
                            <div class="required sixteen wide field">
