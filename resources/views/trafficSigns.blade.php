        ...
        <div class="trafficSignsBox">
            ...
            <div class="mandatorySigns" id="mandatorySigns">
                ...
                <div class="ui two column stackable relaxed grid">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/stop_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/stop_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/stop.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/give_way.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/give_way.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/give_way.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/straight_prohibited_sign.jp.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/straight_prohibited_sign.jp.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/straight_prohibited.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/vehicles_prohibited.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/vehicles_prohibited.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/vehicles_prohibited.gif" alt="" class="ui circular image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/cycle_prohibted.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/cycle_prohibted.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/cycles_prhibited.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/pedestrian_prohibited.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/pedestrian_prohibited.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/pedestrian_prohibited.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/lright_turn_prohibited_sign.situation.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/lright_turn_prohibited_sign.situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/right_turn_prohibited.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/left_turn_prohibited_sign.situation.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/left_turn_prohibited_sign.situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/left_turn_prohibited.gif" alt="" class="ui circular image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/U_turn_prohibited.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/U_turn_prohibited.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/u_turn_prohibited.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/overtaking_prohibited.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/overtaking_prohibited.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/overtaking_prohibited.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/all_motor_vehicles_prohibit.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/all_motor_vehicles_prohibit.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/all_motor_vehicles_prohibit.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/trucks_prohibited.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/trucks_prohibited.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/truck_prohibited.gif" alt="" class="ui circular image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/hand_cart_prohibited.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/hand_cart_prohibited.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/hand_carts_prohibited.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/tonga_prohibited.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/tonga_prohibited.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/tongas_prohibited.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/no_parking.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/no_parking.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/no_parking.gif" alt="" class="ui circular image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/no_parking_no_stopping.jpgg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/no_parking_no_stopping.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/no_stopping_or_standing.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/speed_limit_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/speed_limit_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/speed_limit.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/width_limit.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/width_limit.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/width_limit.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/height_limit.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/height_limit.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/height_limit.gif" alt="" class="ui circular image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/length_limit.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/length_limit.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/length_limit.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/axle_load_limit.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/axle_load_limit.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/load_limit.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/mandatorySigns/axle_load_limit.jpg" onClick="javascript:void window.open('images/trafficSigns/mandatorySigns/axle_load_limit.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/mandatorySigns/axle_load_limit.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
            ...
            <div class="cautionarySigns" id="cautionarySigns" style="display: none;">
                ...
                <div class="ui two column stackable relaxed grid">
                    <div class="row">
                        <div class="column">
                            <a href="images/trafficSigns/cautionarySigns/right_hair_pin_bend_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/right_hair_pin_bend_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/right_hair_pin_bend.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/cautionarySigns/left_hair_pin_bend_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/left_hair_pin_bend_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/left_hair_pin_bend.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                                <b>RIGHT/LEFT HAIR PIN BEND</b> <br />  This sign is used where the change in direction is so considerable that it amounts to reversal of direction. The symbol bends to right or left depending upon the road alignment.
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/cautionarySigns/right_hand_curve_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/right_hand_curve_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/right_hand_curve.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/cautionarySigns/left_hand_curve_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/left_hand_curve_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/left_hand_curve.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                                <b>RIGHT/LEFT HAND CURVE</b> <br />  This sign is used where the direction of alignment changes. The sign forewarns the driver to reduce the speed and proceed cautiously along the road.
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/cautionarySigns/right_reverse_bend_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/right_reverse_bend_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/right_reverse_bend.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/cautionarySigns/left_reverse_bend_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/left_reverse_bend_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/left_reverse_bend.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                                <b>RIGHT/LEFT REVERSE BEND</b> <br />  This sign is used where the nature of the reverse bend is not obvious to approaching traffic and constitutes a hazard. If the first curve is to the right, a right reverse bend shall be used. If the first curve is to the left, a left reverse bend is used.
                        ...
                        <div class="column">
                            <a href="images/trafficSigns/cautionarySigns/narrow_bridge_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/narrow_bridge_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/narrow_bridge.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/gap_in_median.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/narrow_road_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/narrow_road_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/narrow_road.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/road_widens_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/road_widens_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/road_widens.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/cycle_crossing_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/cycle_crossing_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/cycle_crossing.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/pedestrian_crossing.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/pedestrian_crossing.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/pedestrian_crossing.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/school_ahead_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/school_ahead_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/school_ahead.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/men_at_work_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/men_at_work_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/men_at_work.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/side_road_left_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/side_road_left_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/side_road_left.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/side_road_right_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/side_road_right_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/side_road_right.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                                <b>SIDE ROAD LEFT/RIGHT</b> <br />This sign is displayed in advance of the side road intersections where a large volume of entering traffic together with restricted sight distance is likely to constitute a hazard. The driver is warned of the existence of a junction.
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/y_intersection01_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/y_intersection01_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/y_intersection01.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/y_intersection02_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/y_intersection02_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/y_intersection02.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                                <b>Y-INTERSECTION</b> <br />These signs are displayed on the approach to a bifurcation of any road. This sign warns of the existence of a junction and no other indication is given.
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/major_road_ahead01_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/major_road_ahead01_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/major_road_ahead01.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/major_road_ahead_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/major_road_ahead_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/major_road_ahead.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                                <b>MAJOR ROAD</b> <br />These signs are displayed in advance of crossing with the major road, where a sufficiently large volume of traffic together with a sufficiently large volume of traffic together with restricted sight is likely to cause a hazard.
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/staggered_intersection_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/staggered_intersection_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/staggered_intersection.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/staggered_intersection01_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/staggered_intersection01_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/staggered_intersection01.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                                <b>STAGGERED INTERSECTION</b> <br />This sign is used to indicate junctions where the distance between two junctions is not more than 60 meters.
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/t-intersection_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/t-intersection_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/t-intersection.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/round_about_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/round_about_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/round_about.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/start_of_dual_carriageway_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/start_of_dual_carriageway_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/start_of_dual_carriageway.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/end_of_dual_carriageway_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/end_of_dual_carriageway_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/end_of_dual_carriageway.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/reduced_carriageway_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/reduced_carriageway_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/reduced_carriageway.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/reduced_carriageway1_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/reduced_carriageway1_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/reduced_carriageway1.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                                <b>REDUCED CARRIAGEWAY</b> <br />These signs caution the driver of the reduction in the width of the carriageway ahead. This is displayed on undivided carriageways when some portion of the carriageway is closed or reduced for repairs.
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/two_way_traffic_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/two_way_traffic_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/two_way_traffic.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/cross_road_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/cross_road_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/cross_road.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/cattle_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/cattle_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/cattle.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/diversion-to-the-other-carr_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/diversion-to-the-other-carr_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/diversion-to-the-other-carr.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/falling_rocks_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/falling_rocks_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/falling_rocks.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/ferry_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/ferry_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/ferry.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/lane-closed_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/lane-closed_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/lane-closed.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                                <b>FALLING ROCKS</b> <br />This sign is used wherever rocks are liable to fall on the road seasonally or throughout the year. The symbol may be reversed to show the side from which rockfall is expected.
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/lane-closed-three-lane-road_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/lane-closed-three-lane-road_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/lane-closed-three-lane-road.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/barrier_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/barrier_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/barrier.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/Loose_gravel_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/Loose_gravel_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/Loose_gravel.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/overhead-cable_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/overhead-cable_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/overhead-cable.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/quayside-or-river-bank_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/quayside-or-river-bank_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/quayside-or-river-bank.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/series-of-bends_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/series-of-bends_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/series-of-bends.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/slippery_road_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/slippery_road_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/slippery_road.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/steep-ascent_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/steep-ascent_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/steep-ascent.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/steep-descent_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/steep-descent_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/steep-descent.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                                <b>STEEP ASCENT/STEEP DESCENT</b> <br />This sign is displayed before a steep upgrade/downgrade that may constitute a hazard to traffic. A gradient of 10 per cent and above is considered steep gradient.
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/dangerous_dip_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/dangerous_dip_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/dangerous_dip.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
                        ...
                        <div class="column">
                            <a href="images/images/trafficSigns/cautionarySigns/speed_braker_sign_situation.jpg" onClick="javascript:void window.open('images/trafficSigns/cautionarySigns/speed_braker_sign_situation.jpg','1415690218720','width=640,height=450,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">
                                <h2 class="ui centered aligned header"><img src="images/trafficSigns/cautionarySigns/speed_braker.gif" alt="" class="ui image" style="width: 5.5em">
                                </h2>
                            </a>
                            <p style="text-align: center;">
            ...
            <div class="informativeSigns" id="informativeSigns" style="display: none;">
                <div class="ui two column stackable relaxed grid">
                        ...
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="images/trafficSigns/informatorySigns/8.gif" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="images/trafficSigns/informatorySigns/9.gif" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="images/trafficSigns/informatorySigns/11.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="images/trafficSigns/informatorySigns/12.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="images/trafficSigns/informatorySigns/13.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="images/trafficSigns/informatorySigns/14.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="images/trafficSigns/informatorySigns/15.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="images/trafficSigns/informatorySigns/16.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                </div>
                <!--/ui two column stackable relaxed grid-->
            ...
            <div class="allSignsUrdu" id="allSignsUrdu" style="display: none;">
                <div class="ui three column stackable relaxed grid">                    
                        <div class="column">
                            <img src="images/trafficSigns/AllSignsUrdu/mandatorySignsAll.jpg" class="ui image" alt="">
                        </div>
                        <div class="column">
                            <img src="images/trafficSigns/AllSignsUrdu/warningSignsAll.jpg" class="ui image" alt="">
                        </div>
                        <div class="column">
                            <img src="images/trafficSigns/AllSignsUrdu/informativeSignsAll.jpg" class="ui image" alt="">
                        </div>
                </div>
                <!--/ui two column stackable relaxed grid-->
            </div>
