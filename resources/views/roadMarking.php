                ...
                <div class="ui two column stackable relaxed grid">
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/roadMarking/dividingline.png" alt="Picture is Missing" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/roadMarking/brokenline.jpg" alt="Picture is Missing" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/roadMarking/single_continous_line.gif" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/roadMarking/parallel_lines.gif" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/roadMarking/obstruction.gif" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/roadMarking/dividevslane.png" alt="Picture is Missing" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/roadMarking/broken_lane_left.gif" alt="Picture is Missing" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/roadMarking/straddling.gif" alt="Picture is Missing" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/roadMarking/solid_lane_line.gif" alt="Picture is Missing" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/roadMarking/edge_lines.gif" alt="Picture is Missing" class="ui image" style="width: 5.5em"><img src="<?= base_url(); ?>/public/images/roadMarking/parking_prohibited.gif" alt="Picture is Missing" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                </div>
