        ...
        <div class="trafficSignalsBox">
                ...
                <div class="ui two column stackable relaxed grid">
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/Lights/red-light-signal.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/Lights/yellow-light-signal.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/Lights/traffic-light-green1.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/Lights/green-arrow-signal.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/Lights/red-blinker.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="four wide column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/Lights/yellow-traffic-light.jpg" alt="" class="ui image" style="width: 5.5em">
                            </h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="handSignals" id="handSignals" style="display: none;">
                <div class="ui two column stackable relaxed grid">
                    <div class="row">
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/handSignals/1.jpg" alt="" class="ui image" style="width: 5.5em; height: 8.5em;">
                            </h1>
                            <h3>Vehicles approaching from behind must stop.</h3>
                        </div>
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/handSignals/2.jpg" alt="" class="ui image" style="width: 5.5em; height: 8.5em;">
                            </h1>
                    ...
                    <div class="row">
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/handSignals/3.jpg" alt="" class="ui image" style="width: 5.5em; height: 8.5em;">
                            </h1>
                            <h3>Vehicles approaching from left must stop.</h3>
                        </div>
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/handSignals/4.jpg" alt="" class="ui image" style="width: 5.5em; height: 8.5em;">
                            </h1>
                    ...
                    <div class="row">
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/handSignals/5.jpg" alt="" class="ui image" style="width: 5.5em; height: 8.5em;">
                            </h1>
                            <h3>Vehicles approaching from left & right must stop.</h3>
                        </div>
                        <div class="column">
                            <h1 class="ui centered aligned header"><img src="<?= base_url(); ?>/public/images/trafficSignals/handSignals/6.jpg" alt="" class="ui image" style="width: 5.5em; height: 8.5em;">
                            </h1>
