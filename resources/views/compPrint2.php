<?= $this->include('partials/Assets.php'); ?>
        ...
        <div class="ui grid">
            <div class="row">
                <div class="sixteen wide column logo">
                    <img src="<?= base_url();?>/public/img/head.jpg" width="100%" />
                </div>
            </div>
        </div>
    </header>
...
{
     $compID=$key->id;
     $compDate = $key->datetime;
     $compType = $key->comptype;
     $compSubject = $key->compsubject;
     $Name = $key->name;
     $CNIC = $key->cnic;
     $Contact = $key->contact;
     $Email = $key->email;
     ...
     $complaintTo = $key->compto;
     $complaintText = $key->comptext;
     $compStatus = $key->compstatus;
    ...
    <div class="complaintBox ui centered aligned grid">
        <!-- Complaint Box Form-->
        <div class="complaintForm fifteen wide mobile fifteen wide tablet fifteen wide computer column">
            <br />
...
<script>
    setTimeout(function() {
        window.location.href = '<?= base_url();?>/AdminPanel/Complaints';
    }, 1000);
